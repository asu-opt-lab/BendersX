...
ROUND_VERSION="uflp_milp"
ROUND_DESCRIPTION="multiple t, 7 private cores"
EXPERIMENT_VERSION="3"
SEED="1"
HOUR="04"
EXPERIMENT_DESCRIPTION="${HOUR} hr, seed = ${SEED}"

FILE_NAME="uflp_milp.jl"
THREADS=7
...
instances=(
    ...
    "ga250b-1" 
    # "ga250b-2" 
    "ga250b-3" "ga250b-4" "ga250b-5"
    # "ga250c-1" "ga250c-2" "ga250c-3" "ga250c-4" 
    "ga250c-5"

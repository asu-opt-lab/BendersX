*End-to-end workflow for solving the CFLP using built-in BendersX.jl components*

## 1. Mathematical Modeling
The CFLP is defined by the following *parameters*:
...
### Example
A data structure for the Capacitated Facility Location Problem (CFLP) may be written as:
```julia
